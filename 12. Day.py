def function_open_list(filepath):
    with open(filepath, "r") as file_local:
        user_to_do_list_local = file_local.readlines()
    return user_to_do_list_local


def function_save_list(filepath, user_to_do_list_arg):
    with open(filepath, "w") as file_local:
        file_local.writelines(user_to_do_list_arg)


def function_show_positions():
